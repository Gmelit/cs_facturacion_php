...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2023 a las 03:40:27
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUser` (IN `usuario` VARCHAR(100), IN `contrasenia` VARCHAR(50))  SELECT
*
FROM Usuario where usuario = usuario and clave = contrasenia$$
...
INSERT INTO `usuario` (`idusuario`, `nombre`, `correo`, `usuario`, `clave`, `idRol`, `fechaRegistro`) VALUES
(1, 'Sebas', 'sebastianmacias@gmail.com', 'sebas', '123', 1, '2023-03-29 19:34:29');
